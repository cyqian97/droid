...
class FrankaControl(object):
    ...
    def SetEETarget(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/franka_control.FrankaControl/SetEETarget',
    ...
    def ResetToJoints(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/franka_control.FrankaControl/ResetToJoints',
